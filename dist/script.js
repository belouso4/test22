...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_accordion__WEBPACK_IMPORTED_MODULE_0__["default"])('.accordion-item');
  ...
  btns.forEach(function (btn) {
    btn.addEventListener('click', function () {
      ...
      btns.forEach(function (bt) {
        if (bt !== _this === bt.classList.contains('active-style')) {
...
var modals = function modals() {
  ...
  bindModal('.button-phone', '.popup-phone', '.popup-phone .popup-close'); // showModalByTime('.popup-consultation', 6000)
};
